    ...
    return (
      <div className="flex min-h-screen flex-col bg-background pt-6">
        <header className="w-full p-4">
          <Link
            href="/"
            className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white/70 transition-colors hover:text-primary"
          >
      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-background/95 shadow-sm backdrop-blur-xl">
        <div className="mx-auto flex max-w-2xl items-center justify-between px-3 py-3.5 sm:px-4">
          <div className="flex items-center gap-3">
            <Link
              href="/"
              className="flex h-9 w-9 items-center justify-center rounded-full bg-white/5 text-white/90 transition-colors hover:bg-white/10"
            >
              <ArrowLeft className="h-5 w-5" />
            </Link>
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-5 px-3 pb-8 pt-5 sm:gap-6 sm:px-4">
        <section>
          <div className="mb-3 flex items-center justify-between px-1">
            ...
            <button
              onClick={clearCart}
              className="inline-flex items-center gap-1.5 rounded-lg border border-red-500/35 bg-red-500/10 px-2.5 py-1 text-[11px] font-bold uppercase tracking-wide text-red-300 transition-colors hover:bg-red-500/20 hover:text-red-200"
            >
        ...
        <section className="mt-2 rounded-2xl border border-white/10 bg-card p-4 shadow-md">
          <div className="flex items-center justify-between gap-4">
            ...
            <Link
              href="/checkout"
              className="group flex flex-1 items-center justify-center gap-2 rounded-xl bg-primary px-5 py-3.5 text-base font-extrabold text-black transition-all hover:bg-primary/90 active:scale-[0.98] sm:text-lg"
            >
              Continuar
