  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-background/95 backdrop-blur-md">
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between gap-2 px-3 sm:px-4">
        ...
        <button onClick={() => router.push('/cart')} className="relative flex rounded-lg border border-white/10 bg-white/5 p-2 text-white transition-all hover:bg-white/10 active:scale-95 shrink-0" aria-label="Abrir carrito">
